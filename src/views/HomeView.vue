  ...
  <v-container fluid class="home-view-container pa-4 pa-sm-6">
    <v-row justify="center">
      <v-col cols="12" md="11" lg="10">
        ...
        <v-row class="mb-6" v-if="authStore.isLoggedIn">
...
const allQuickActions = ref([
  { title: 'Mis Requerimientos', icon: 'mdi-format-list-checks', color: 'primary', variant: 'tonal', to: { name: 'gestionRequerimientos' }, roles: ['Solicitante', 'JefeAprobador', 'Administrador'] },
]);
...
const verDetalleRequerimiento = (id) => {
  ...
  console.log(`Navegar al detalle del requerimiento ID: ${id} (o abrir modal)`);
};
